...
#./mjpg_streamer -i "./input_testpicture.so -r 320x240 -d 1000" -o "./output_http.so -w ./www"
./mjpg_streamer -i "./input_uvc.so -n -f 10 -r 320x240 -d /dev/video0" -o "./output_http.so -w ./www" 
#./mjpg_streamer -i "./input_uvc.so -n -f 10 -r 320x240 -d /dev/video0" -o "./output_http.so -w ./www" -b 

#./mjpg_streamer -i "./input_uvc.so -n -f 10 -r 640x480"  -o "./output_http.so -w ./www" 
